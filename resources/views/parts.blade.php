		 ...
		 <div class="bike-parts-sec">
		      <div class="bike-parts">
				 ...
				 <div class="bike-apparels">
					 ...
					 <div class="parts2">
						 <a href="{{asset('single')}}"><div class="part-sec">					 
							 <img src="public/images/p5.JPG" alt=""/>
							 <div class="part-info">
						 ...
						 <a href="{{asset('single')}}"><div class="part-sec none1">					 
							 <img src="public/images/p7.JPG" alt=""/>
							 <div class="part-info">
						 ...
						 <a href="{{asset('single')}}"><div class="part-sec none1">					 
							 <img src="public/images/p8.jpg" alt=""/>
							 <div class="part-info">
					 ...
					 <div class="parts3">
						 <a href="{{asset('single')}}"><div class="part-sec">					 
							 <img src="public/images/p9.jpg" alt=""/>
							 <div class="part-info">
						 ...
						 <a href="{{asset('single')}}"><div class="part-sec">					 
							 <img src="public/images/p10.jpg" alt=""/>
							 <div class="part-info">
						 ...
						 <a href="{{asset('single')}}"><div class="part-sec none1">					 
							 <img src="public/images/p11.jpg" alt=""/>
							 <div class="part-info">
						 ...
						 <a href="{{asset('single')}}"><div class="part-sec none1">					 
							 <img src="public/images/p12.jpg" alt=""/>
							 <div class="part-info">
					 ...
					 <div class="parts4">
						 <a href="{{asset('single')}}"><div class="part-sec bottom-line">					 
							 <img src="public/images/p13.jpg" alt=""/>
							 <div class="part-info">
						 ...
						 <a href="{{asset('single')}}"><div class="part-sec bottom-line">					 
							 <img src="public/images/p14.jpg" alt=""/>
							 <div class="part-info">
						 ...
						 <a href="{{asset('single')}}"><div class="part-sec bottom-line none1">					 
							 <img src="public/images/p15.jpg" alt=""/>
							 <div class="part-info">
						 ...
						 <a href="{{asset('single')}}"><div class="part-sec none1">					 
							 <img src="public/images/p16.JPG" alt=""/>
							 <div class="part-info">
