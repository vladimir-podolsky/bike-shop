	 ...
	 <div class="container">
		 ...
		 <div class="bike-parts acces">
			 ...
			 <div class="bike-apparels">
				 <div class="parts1">
					 <a href="{{asset('single')}}"><div class="part-sec">					 
						 <img src="public/images/a1.JPG" alt=""/>
						 <div class="part-info">
							 <a href="#"><h5>Bike Fenders<span>$7.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
					 <a href="{{asset('single')}}"><div class="part-sec">					 
						 <img src="public/images/a3.png" alt=""/>
						 <div class="part-info">
							 <a href="{{asset('single')}}"><h5>Cycling Helmets<span>$50.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
					 <a href="{{asset('single')}}"><div class="part-sec none2">					 
						 <img src="public/images/a2.jpg" alt=""/>
						 <div class="part-info">
							 <a href="{{asset('single')}}"><h5>Handle Grips<span>$200.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
					 <a href="{{asset('single')}}"><div class="part-sec none1">					 
						 <img src="public/images/a4.jpg" alt=""/>
						 <div class="part-info">
							 <a href="{{asset('single')}}"><h5>Hydration Pack Black<span>$200.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
				 ...
				 <div class="parts2">
					 <a href="{{asset('single')}}"><div class="part-sec">					 
						 ...
						 <div class="part-info">
							 <a href="{{asset('single')}}"><h5>Electronics<span>$200.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
					 <a href="{{asset('single')}}"><div class="part-sec">					 
						 ...
						 <div class="part-info">
							 <a href="{{asset('single')}}"><h5>Bike Panniers <span>$200.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
					 <a href="{{asset('single')}}"><div class="part-sec none2">					 
						 ...
						 <div class="part-info">
							 <a href="{{asset('single')}}"><h5>Timbre Bell<span>$200.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
					 <a href="{{asset('single')}}"><div class="part-sec none1">					 
						 <img src="public/images/a8.jpg" alt=""/>
						 <div class="part-info">
							 <a href="{{asset('single')}}"><h5>Back Stands<span>$200.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
				 ...
				 <div class="parts3">
					 <a href="{{asset('single')}}"><div class="part-sec">					 
						 <img src="public/images/a9.jpg" alt=""/>
						 <div class="part-info">
							 <a href="{{asset('single')}}"><h5>Disc Breaks<span>$200.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
					 <a href="{{asset('single')}}"><div class="part-sec">					 
						 <img src="public/images/a10.jpg" alt=""/>
						 <div class="part-info">
					 ...
					 <a href="{{asset('single')}}"><div class="part-sec none2">					 
						 <img src="public/images/a11.jpg" alt=""/>
						 <div class="part-info">
					 ...
					 <a href="{{asset('single')}}"><div class="part-sec none1">					 
						 <img src="public/images/a12.jpg" alt=""/>
						 <div class="part-info">
							 <a href="{{asset('single')}}"><h5>Body Armours<span>$200.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
				 ...
				 <div class="parts4">
					 <a href="{{asset('single')}}"><div class="part-sec bottom-line">					 
						 <img src="public/images/a13.jpg" alt=""/>
						 <div class="part-info">
					 ...
					 <a href="v"><div class="part-sec bottom-line">					 
						 <img src="public/images/a14.JPG" alt=""/>
						 <div class="part-info">
					 ...
					 <a href="{{asset('single')}}"><div class="part-sec bottom-line none2">					 
						 <img class="bottle"src="public/images/a15.jpg" alt=""/>
						 <div class="part-info">
							 <a href="{{asset('single')}}"><h5>Water Bottles<span>$200.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
					 <a href="{{asset('single')}}"><div class="part-sec none1">					 
						 <img src="public/images/a16.JPG" alt=""/>
						 <div class="part-info">
							 <a href="{{asset('single')}}"><h5>Bicycle Mirrors<span>$200.00</span></h5></a>
							 <a class="add-cart" href="{{asset('single')}}">Quick View</a>
							 <a class="qck" href="{{asset('single')}}">BUY NOW</a>
						 </div>
					 </div></a>
